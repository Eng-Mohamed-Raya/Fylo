         ...
         <section className="my-[100px]">
            <div className="container element-center flex-col lg:flex-row gap-10 px-2.5 sm:px-0">
                <div className="h-[400px] max-h-full">
                    <img src="/src/assets/images/illustration-stay-productive.png" alt="img" className="w-full h-full"/>
                </div>
                <div>
                    ...
                    <a href="/" className="flex gap-1 border-b w-40 text-[#65e2d9] text-sm ">See how Fylo works <img src="/src/assets/images/icon-arrow.svg" alt="img" className="animate-[moveRight_1s_ease-in-out_infinite]"/></a>
                </div>
            </div>
         </section>
    );
